...
//метод нахождения суммы нечётных элементов массива
int ColculateTask(int[] inputArray)
{
    ...
    while(i<15)
    {
        //проверкаи на условие нечётности элемента
        if(i%2 == 1) 
        {
...
Console.WriteLine("сумма чисел нечётных позиций в массиве = "+ColculateTask(bufferArray));
